...
plt.xlabel(r'$\beta_0$')
plt.title(r'$\beta$={:.2f}$\pm${:.2f}'.format(np.mean(lista_b0[10000:]),np.std(lista_b0[10000:])))

plt.subplot(2,3,2)
histo = plt.hist(lista_b1[10000:], bins=15, density=True)
plt.xlabel(r'$\beta_1$')
plt.title(r'$\beta$={:.2f}$\pm${:.2f}'.format(np.mean(lista_b1[10000:]),np.std(lista_b1[10000:])))

plt.subplot(2,3,3)
histo = plt.hist(lista_b2[10000:], bins=15, density=True)
plt.xlabel(r'$\beta_2$')
plt.title(r'$\beta$={:.2f}$\pm${:.2f}'.format(np.mean(lista_b2[10000:]),np.std(lista_b2[10000:])))

plt.subplot(2,3,4)
histo = plt.hist(lista_b3[10000:], bins=15, density=True)
plt.xlabel(r'$\beta_3$')
plt.title(r'$\beta$={:.2f}$\pm${:.2f}'.format(np.mean(lista_b3[10000:]),np.std(lista_b3[10000:])))

plt.subplot(2,3,5)
histo = plt.hist(lista_b4[10000:], bins=15, density=True)
plt.xlabel(r'$\beta_4$')
plt.title(r'$\beta$={:.2f}$\pm${:.2f}'.format(np.mean(lista_b4[10000:]),np.std(lista_b4[10000:])))
